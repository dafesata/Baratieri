...
public class ActivityScan extends AppCompatActivity implements ZBarScannerView.ResultHandler {
    private String TAG= ActivityScan.class.getName();
    ...
    private void showMessageOKCancel(String message, DialogInterface.OnClickListener okListener) {
        new android.support.v7.app.AlertDialog.Builder(ActivityScan.this)
                .setMessage(message)
